...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 bg-gradient-to-br from-[#FF2D20]/20 via-purple-600/10 to-transparent text-black/50 dark:bg-zinc-900 dark:text-white/50">
    <div class="min-h-screen flex flex-col justify-between">
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white flex-grow">
                ...
                <header class="grid grid-cols-1 items-center gap-2 py-10">
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex justify-start space-x-4">
                            ...
                            @else
                                <a href="{{ route('login') }}"
                                    class="bg-gradient-to-r from-[#FF2D20] to-purple-600 text-white px-6 py-3 rounded-full 
                                           text-lg font-semibold hover:shadow-lg transition-all duration-300">
                                    Iniciar Sesión
                                </a>
